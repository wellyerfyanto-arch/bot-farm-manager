...
// Add force stop button ke UI
function addForceStopButton() {
    const controlPanel = document.querySelector('.card-body .row.g-3');
    // Cek apakah button sudah ada
    if (document.getElementById('forceStopBtn')) return;
    ...
    `;
    controlPanel.innerHTML += forceStopHtml;
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    updateStats();
    loadProfilesList();
    addForceStopButton(); // Tambahkan force stop button
